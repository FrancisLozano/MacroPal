...
enum ExerciseGuides {
    ...
    private static let byName: [String: ExerciseGuide] = [
        ...
        "single-arm cable triceps extension": guide([
            ...
            "Extend your arm down in front of you until it's straight, moving only at the elbow.",
            "Let the handle come back up slowly until your forearm is just past level.",
        ], [
