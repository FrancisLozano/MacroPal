...
## Scope
- [x] Weight trend chart (raw + rolling 7-day average — raw daily weight is noisy), with your current goal weight shown as a reference line
- [x] Macro adherence chart (e.g. last 14 days, calories vs. target)
- [x] Workout progression chart per exercise (top set weight over time, estimated 1RM)
