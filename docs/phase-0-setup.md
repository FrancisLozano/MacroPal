...
- [x] Create the Xcode project: SwiftUI App template, iOS 17+ deployment target, SwiftData enabled
- [x] Set the app's bundle identifier
- [x] Lay out the folder structure from [SPEC.md §7](../SPEC.md#7-repository--git-workflow) (`Models/`, `Views/`, `ViewModels/`, `Engine/`, `Resources/`)
- [x] Confirm the empty app builds and runs in the iOS Simulator
- [x] Commit and push the project scaffold
